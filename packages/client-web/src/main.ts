...
const EXTERNAL_STATION_CONFIGS: ExternalStationConfig[] = [
  ...
  // From Are.na channel online-radios-zlvblzsstly (121 links); stream URLs from Radio Browser API + known patterns
  { name: "Manila Community Radio", description: "Independent, not-for-profit radio platform made by the community for the community.", websiteUrl: "https://manilacommunityradio.live/", streamUrl: "https://manilacommunityradio.out.airtime.pro/manilacommunityradio_a", logoUrl: "https://manilacommunityradio.live/favicon.ico" },
  { name: "N10.AS RADIO", description: "World wide wadio.", websiteUrl: "https://n10.as/", streamUrl: "https://n10.as/stream", logoUrl: "https://n10.as/favicon.ico" },
  { name: "ISO", description: "Online radio from downtown Toronto. Underground music and untold stories, streaming five days a week.", websiteUrl: "https://iso.fm/", streamUrl: "https://stream.iso.fm/live", logoUrl: "https://iso.fm/favicon.ico" },
  { name: "Rinse FM", description: "London radio airwaves for 20 years. Hub of the capital's thriving urban music community.", websiteUrl: "https://rinse.fm/", streamUrl: "https://media.rinse.fm:443/stream", logoUrl: "https://rinse.fm/favicon.ico" },
  { name: "dublab", description: "Online radio. Multiple cities.", websiteUrl: "https://www.dublab.com/", streamUrl: "https://stream.dublab.com/live", logoUrl: "https://dublab.com/favicon.ico" },
  { name: "Worldwide FM", description: "Award winning radio station with a global audience.", websiteUrl: "https://worldwidefm.net/", streamUrl: "https://worldwidefm.out.airtime.pro/worldwidefm_a", logoUrl: "https://worldwidefm.net/favicon.ico" },
  { name: "DKFM Shoegaze Radio", description: "Shoegaze and related sounds.", websiteUrl: "https://decayfm.com/", streamUrl: "https://decayfm.com/stream", logoUrl: "https://decayfm.com/favicon.ico" },
  { name: "Radio WORM", description: "Rotterdam-based organisation at the intersection of culture and arts. The rebirth of Radio WORM.", websiteUrl: "https://worm.org/projects/radio-worm/", streamUrl: "https://worm.org/stream/radio-worm", logoUrl: "https://worm.org/favicon.ico" },
  { name: "FIP", description: "French public radio. Jazz, Reggae, Rock, Electro, Soul.", websiteUrl: "https://www.fip.fr/", streamUrl: "https://icecast.radiofrance.fr/fip-midfi.mp3", logoUrl: "https://fip.fr/favicon.ico" },
  { name: "RADAR 97.8 FM", description: "Lisbon. Observatório RADAR.", websiteUrl: "https://radarlisboa.fm/", streamUrl: "https://radarlisboa.out.airtime.pro/radarlisboa_a", logoUrl: "https://radarlisboa.fm/favicon.ico" },
  { name: "Radio Student Slovenia", description: "Student radio. Multiple bitrates.", websiteUrl: "https://radiostudent.si/", streamUrl: "https://stream.radiostudent.si/radiostudent", logoUrl: "https://radiostudent.si/favicon.ico" },
  { name: "Methods of Mellow", description: "Mellow sounds.", websiteUrl: "https://methodsofmellow.com/", streamUrl: "https://stream.methodsofmellow.com/stream", logoUrl: "https://methodsofmellow.com/favicon.ico" },
  ...
  { name: "Mushroom Radio", description: "Student-run radio.", websiteUrl: "https://radiomushroom.org/", streamUrl: "https://radiomushroom.out.airtime.pro/radiomushroom_a", logoUrl: "https://radiomushroom.org/favicon.ico" },
  { name: "BFF.fm", description: "San Francisco community radio. Emerging and underground artists.", websiteUrl: "https://bff.fm/", streamUrl: "https://stream.bff.fm/stream", logoUrl: "https://bff.fm/favicon.ico" },
  ...
  { name: "Echobox Radio", description: "Independent online radio. DIY enthusiasm with the quality of FM.", websiteUrl: "https://echobox.radio/", streamUrl: "https://echobox.out.airtime.pro/echobox_a", logoUrl: "https://echobox.radio/favicon.ico" },
  { name: "Radio Radio", description: "Pop-up DJ bar in Amsterdam Westerpark. Global radio shows and livesets.", websiteUrl: "https://radioradio.radio/", streamUrl: "https://stream.radioradio.radio/stream", logoUrl: "https://radioradio.radio/favicon.ico" },
  { name: "Radio Tempo Não Pára", description: "Independent online radio based in Amsterdam. Guest mixes, radio shows.", websiteUrl: "https://radio-tnp.com/", streamUrl: "https://radio-tnp.out.airtime.pro/radio-tnp_a", logoUrl: "https://radio-tnp.com/favicon.ico" },
  ...
  { name: "Internet Public Radio", description: "Independent cultural platform and radio station broadcasting from Guadalajara, Latin America, Europe.", websiteUrl: "https://internetpublicradio.live/", streamUrl: "https://internetpublicradio.out.airtime.pro/internetpublicradio_a", logoUrl: "https://internetpublicradio.live/favicon.ico" },
  { name: "FRISKY", description: "Electronic music internet radio and DJ mix subscription service. Listen for free.", websiteUrl: "https://www.friskyradio.com/", streamUrl: "https://stream.friskyradio.com/stream", logoUrl: "https://friskyradio.com/favicon.ico" },
  ...
  { name: "Montez Press Radio", description: "Archive and live. Reading and poetry, sound.", websiteUrl: "https://radio.montezpress.com/", streamUrl: "https://stream.montezpress.com/icecast/reading-and-poetry-the-sounded-word", logoUrl: "https://radio.montezpress.com/favicon.ico" },
  { name: "Club Night Club", description: "Club Night Club radio.", websiteUrl: "https://clubnightclub.com/", streamUrl: "https://clubnightclub.out.airtime.pro/clubnightclub_a", logoUrl: "https://clubnightclub.com/favicon.ico" },
  { name: "Public Records", description: "Community broadcasting platform. Diverse programming, experimentation.", websiteUrl: "https://publicrecords.tv/", streamUrl: "https://publicrecords.out.airtime.pro/publicrecords_a", logoUrl: "https://publicrecords.tv/favicon.ico" },
  { name: "Wax Radio", description: "Internet radio from Greenpoint, Brooklyn. Wax Studios community.", websiteUrl: "https://wax.radio/", streamUrl: "https://wax.out.airtime.pro/wax_a", logoUrl: "https://wax.radio/favicon.ico" },
  { name: "Bar Part Time Radio", description: "Radio from Bar Part Time.", websiteUrl: "https://www.barparttime.com/radio/", streamUrl: "https://barparttime.out.airtime.pro/barparttime_a", logoUrl: "https://barparttime.com/favicon.ico" },
  { name: "India Street Radio", description: "Wide range of sonic territory from balearic to jazz-funk, strictly vinyl.", websiteUrl: "https://indiastreetradio.com/", streamUrl: "https://indiastreetradio.out.airtime.pro/indiastreetradio_a", logoUrl: "https://indiastreetradio.com/favicon.ico" },
  { name: "The Lot Radio", description: "24/7 from a reclaimed shipping container on an empty lot in NYC. Best and most varied music.", websiteUrl: "https://www.thelotradio.com/", streamUrl: "https://stream.thelotradio.com/thelotradio", logoUrl: "https://thelotradio.com/favicon.ico" },
  ...
  { name: "Oddity Radio", description: "Exclusive soundtrack for Oddity, cultural space in Paris. Labels and curators.", websiteUrl: "https://oddityradio.fm/", streamUrl: "https://oddityradio.out.airtime.pro/oddityradio_a", logoUrl: "https://oddityradio.fm/favicon.ico" },
  { name: "The Lake Radio", description: "Online radio.", websiteUrl: "https://thelakeradio.com/", streamUrl: "https://thelakeradio.out.airtime.pro/thelakeradio_a", logoUrl: "https://thelakeradio.com/favicon.ico" },
  { name: "datafruits.fm", description: "The world wide web's wackiest radio station. It's just a website.", websiteUrl: "https://www.datafruits.fm/", streamUrl: "https://stream.datafruits.fm/stream", logoUrl: "https://datafruits.fm/favicon.ico" },
  { name: "Secousse", description: "Radio. Fantastic Tchico.", websiteUrl: "https://secousse.tv/", streamUrl: "https://secousse.out.airtime.pro/secousse_a", logoUrl: "https://secousse.tv/favicon.ico" },
  ...
  { name: "RADIORAGEUSES", description: "Émissions radiophoniques de féministes, gouines, trans, femmes. Découvrir, écouter, télécharger.", websiteUrl: "https://www.radiorageuses.net/", streamUrl: "https://radiorageuses.out.airtime.pro/radiorageuses_a", logoUrl: "https://radiorageuses.net/favicon.ico" },
  ...
  { name: "CHIRP Radio", description: "Chicago Independent Radio Project. Listener-supported music and arts. 150+ volunteers.", websiteUrl: "https://chirpradio.org/", streamUrl: "https://stream.chirpradio.org/chirpradio", logoUrl: "https://chirpradio.org/favicon.ico" },
  { name: "lumbung Radio", description: "Inter-local online community radio part of documenta fifteen. Multiple radios and audio practices.", websiteUrl: "https://lumbungradio.stationofcommons.org/", streamUrl: "https://lumbungradio.out.airtime.pro/lumbungradio_a", logoUrl: "https://lumbungradio.stationofcommons.org/favicon.ico" },
  { name: "RTM.FM", description: "Radio station in Thamesmead, SE London. TACO! artist space. Community culture, debate, art and music.", websiteUrl: "https://rtm.fm/", streamUrl: "https://rtm.out.airtime.pro/rtm_a", logoUrl: "https://rtm.fm/favicon.ico" },
  ...
  { name: "SutroFM", description: "Independent online radio. San Francisco, CA.", websiteUrl: "https://www.sutrofm.net/", streamUrl: "https://sutrofm.out.airtime.pro/sutrofm_a", logoUrl: "https://sutrofm.net/favicon.ico" },
  { name: "Lower Grand Radio", description: "Live stream and recorded radio from Oakland and beyond. No set schedule.", websiteUrl: "https://www.lowergrandradio.com/", streamUrl: "https://lowergrandradio.out.airtime.pro/lowergrandradio_a", logoUrl: "https://lowergrandradio.com/favicon.ico" },
  { name: "sfSoundRadio", description: "San Francisco Bay Area New Music.", websiteUrl: "https://sfsound.org/radio.html", streamUrl: "https://sfsound.org/stream", logoUrl: "https://sfsound.org/favicon.ico" },
  { name: "movement.radio", description: "For the day that hope is not a problem. Onassis Stegi.", websiteUrl: "https://movement.radio/", streamUrl: "https://movement.out.airtime.pro/movement_a", logoUrl: "https://movement.radio/favicon.ico" },
  { name: "Moon Glow Radio", description: "DIY radio from Los Angeles. BIPOC and marginalized voices.", websiteUrl: "https://moonglowradio.net/", streamUrl: "https://moonglowradio.out.airtime.pro/moonglowradio_a", logoUrl: "https://moonglowradio.net/favicon.ico" },
  ...
  { name: "Radio Nopal", description: "Comunidad de radio desde Ciudad de México.", websiteUrl: "https://radionopal.com/", streamUrl: "https://radionopal.out.airtime.pro/radionopal_a", logoUrl: "https://radionopal.com/favicon.ico" },
  { name: "Resonance Extra", description: "24/7 digital platform. Global music, sound art and radio art. Resonance, London.", websiteUrl: "https://extra.resonance.fm/", streamUrl: "https://stream.resonance.fm/resonance-extra", logoUrl: "https://extra.resonance.fm/favicon.ico" },
  ...
  { name: "Frilo Radio", description: "Online radio.", websiteUrl: "https://frilo.cool/", streamUrl: "https://frilo.cool/stream", logoUrl: "https://frilo.cool/favicon.ico" },
  { name: "Terry Radio", description: "Best Internet Radio.", websiteUrl: "https://terryradio.biz/", streamUrl: "https://terryradio.out.airtime.pro/terryradio_a", logoUrl: "https://terryradio.biz/favicon.ico" },
  { name: "TSUBAKI fm", description: "Platform for independent music from Tokyo. Underground scene, artists and listeners worldwide.", websiteUrl: "https://tsubakifm.com/", streamUrl: "https://tsubakifm.out.airtime.pro/tsubakifm_a", logoUrl: "https://tsubakifm.com/favicon.ico" },
  { name: "Automat Radio", description: "Music on the Road. Milan Design Week, block parties.", websiteUrl: "https://www.automatradio.com/", streamUrl: "https://automatradio.out.airtime.pro/automatradio_a", logoUrl: "https://automatradio.com/favicon.ico" },
  { name: "Ambient Flo", description: "24hr ambient radio. Deep musical relaxation. Curated by Auntie Flo and friends.", websiteUrl: "https://www.ambientflo.com/", streamUrl: "https://ambientflo.out.airtime.pro/ambientflo_a", logoUrl: "https://ambientflo.com/favicon.ico" },
  { name: "WOBC Oberlin", description: "Oberlin College student radio.", websiteUrl: "https://wobc-fm.org/", streamUrl: "https://wobc-fm.org/stream", logoUrl: "https://wobc-fm.org/favicon.ico" },
  { name: "onoffon radio", description: "A handmade online radio.", websiteUrl: "https://www.radioo.space/", streamUrl: "https://radioo.space/stream", logoUrl: "https://radioo.space/favicon.ico" },
];
